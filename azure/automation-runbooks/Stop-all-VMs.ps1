<#
    .Description
        This runbook deallocates (Power off) all vms in a given resource group
    .Inputs
...
# Get all VMs and Deallocate them

Write-Output "==> Deallocating all VMs in the resource group: $rgname"
...
Write-Output "==> VMs have been deallocated"